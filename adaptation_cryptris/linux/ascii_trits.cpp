...
const string asciiToTrits_path = "files/gen/asciiToTrits.txt";
const string tritsToAscii_path = "files/gen/tritsToAscii.txt";
...
vector<int> asciiToTrits(vector<char> ascii)
{
	...
	ofstream att (asciiToTrits_path.c_str());
	if(att.is_open())
	{
		att << "ascii : ";
	...
	{
		cout << "Unable to open asciiToTrits.txt !" << endl;
	}
	att << endl;
	att.close();
...
vector<char> tritsToAscii(vector<int> trits)
{
	...
	ofstream f (tritsToAscii_path.c_str());
	if(f.is_open())
	{
		f << "trits : ";
	...
	{
		cout << "Unable to open tritsToAscii.txt !" << endl;
	}
	f << endl;
	f.close();
